...
public class paintMarking extends JFrame {
	...
	public static void setTool(marking.ShapeTool shapeTool) {
		tool = shapeTool;
	...
	// ------------------------------------- //
	JPanel panel;
	MarkingMenu mainMenu;

	static MarkingMenu toolsMenu;

	static MarkingMenu colorsMenu;
	...
	private void initMenus() {
		...
		mainMenu = new MarkingMenu(items);
		...
		toolsMenu = new MarkingMenu(items);
		toolsMenu.setVisible(false);
		...
		colorsMenu = new MarkingMenu(items);
		colorsMenu.setVisible(false);
	...
	public paintMarking(String title) {
		super(title);
